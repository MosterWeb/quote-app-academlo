...
const CardQuotes = ({ quotes }) => {
    ...
    return (
        <div >
            ...
            <a href="https://twitter.com/intent/tweet?text=Te%20comparto%20mi%20Quote%20app&url=http%3A%2F%2Freact.me%2Fblog&via=parzibyte&hashtags=programación,react" target="_blank" className="card-quotes__ico-twiter"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-brand-twitter" width="32" height="32" viewBox="0 0 24 24" stroke-width="1.5" stroke="#000000" fill="none" stroke-linecap="round" stroke-linejoin="round">
